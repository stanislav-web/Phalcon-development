...
# Схема: phalcon.local
# Время создания: 2015-02-02 15:09:17 +0000
# ************************************************************
...
INSERT INTO `users` (`id`, `login`, `name`, `surname`, `password`, `salt`, `token`, `state`, `rating`, `ip`, `ua`, `date_registration`, `date_lastvisit`)
VALUES
	(10,'stanisov@gmail.com','stanisov@gmail.com','','$2a$08$Uj6TdGZuLzagWw0TkqtQHe5HqAvvbsFanUNdD.d77YBLhlUp9x.p6','5fbb35981afe2e7e03bf49e18d77a4db','eaf512ae86167612e0d882c5fde29381','0',0,2130706433,'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_4) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/40.0.2214.91 Safari/537.36','2015-02-02 12:30:28','2015-02-02 12:32:28');
