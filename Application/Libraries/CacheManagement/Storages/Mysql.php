 ...
 * @filesource /Application/Libraries/Storages/Mysql.php
 */
class Mysql extends \Phalcon\Mvc\Model
    implements AwareInterface
{
    ...
    public function initialize()
    {
        if (!extension_loaded('PDO'))
            throw new CacheExceptions(printf($this->_status[100], 'PDO'), 100);
    ...
    public function getServerStatus()
    {
        ...
        if ($result === null) {
            ...
            $result = Node::arrayToPair($result);
