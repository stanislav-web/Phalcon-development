 ...
 * @filesource /Application/Libraries/Navigation/Render.php
 */
class Render
{
     ...
     * Create ul elements
     *
     * @param \Application\Libraries\Navigation\Node $node
     * @access private
     * @return null
     */
    private function _generate(\Application\Libraries\Navigation\Node $node)
    {
