...
!function () {
...
}(), qq.version = "5.0.5", qq.supportedFeatures = function () {
    "use strict";
    function a() {
        var a, b = !0;
        try {
    ...
    qq.extend(g, a), d = qq.getUniqueId(), qq(g.element).css({
        ...
        getInput: function () {
            ...
            c.parentNode && qq(c).remove(), qq(g.element).removeClass(g.focusClass), c = b()
        }
    }), c = b()
    ...
    qq.basePublicApi = {
        addBlobs: function (a, b, c) {
            ...
            if (this._currentBatchId = h, a) {
                for (qq.isFileList(a) || (a = [].concat(a)), d = 0; d < a.length; d += 1)if (e = a[d], qq.isFileOrInput(e))if (qq.isInput(e) && qq.supportedFeatures.ajaxUploading)for (f = 0; f < e.files.length; f++)this._handleNewFile(e.files[f], h, g); else this._handleNewFile(e, h, g); else this.log(e + " is not a File or INPUT element!  Ignoring!", "warn");
            ...
            } else e.failure({container: b, error: "Missing image generator module"});
            return e
            ...
            var a;
            if (0 === this._storedIds.length)this._itemError("noFilesError"); else for (; this._storedIds.length;)a = this._storedIds.shift(), this._uploadFile(a)
        }
    }, qq.basePrivateApi = {
        _addCannedFile: function (a) {
            ...
            } : {name: this.getUploads({id: a.id}).name, size: this.getUploads({id: a.id}).size}
            ...
            var a = this;
            if (this._options.workarounds.ios8SafariUploads && qq.ios8() && qq.iosSafari())throw setTimeout(function () {
    ...
    qq.FineUploaderBasic = function (a) {
        ...
        this._options = {
            ...
            workarounds: {iosEmptyVideos: !0, ios8SafariUploads: !0, ios8BrowserCrash: !0}
    ...
    var s, t, u = [], v = {}, w = {
        ...
        successfulResponseCodes: {DELETE: [200, 202, 204], POST: [200, 204], GET: [200]},
    ...
    qq.extend(this, new qq.UploadHandler(a)), qq.override(this, function (a) {
        return {
            add: function (b, d) {
                if (qq.isFile(d) || qq.isBlob(d))a.add(b, {file: d}); else {
    ...
    qq.uiPublicApi = {
        ...
        _getButton: function (a) {
            ...
            if (!f) {
                if (this._options.display.prependFiles && (this._totalFilesInBatch > 1 && this._filesInBatchAddedToUi > 0 && (e = this._filesInBatchAddedToUi - 1), d = {index: e}), !c && (this._options.disableCancelForFormUploads && !qq.supportedFeatures.ajaxUploading && this._templating.disableCancel(), !this._options.multiple)) {
                    var g = this.getUploads({id: a});
    ...
    this._parent = b ? qq[b].FineUploaderBasic : qq.FineUploaderBasic, this._parent.apply(this, arguments), qq.extend(this._options, {
        ...
        thumbnails: {placeholders: {waitUntilResponse: !1, notAvailablePath: null, waitingPath: null}},
    ...
    function b() {
        ...
        if (b = qq.trimStr(b), d = document.createElement("div"), d.appendChild(qq.toElement(b)), P.button && (f = qq(d).getByClass(Q.button)[0], f && qq(f).remove()), qq.DragAndDrop && qq.supportedFeatures.fileDrop || (i = qq(d).getByClass(Q.dropProcessing)[0], i && qq(i).remove()), g = qq(d).getByClass(Q.drop)[0], g && !qq.DragAndDrop && (A("DnD module unavailable.", "info"), qq(g).remove()), g && !qq.supportedFeatures.fileDrop && qq(g).hasAttribute(M) && qq(g).css({display: "none"}), h = qq(d).getByClass(Q.thumbnail)[0], G ? h && (O = parseInt(h.getAttribute(K)), O = O > 0 ? O : null, H = qq(h).hasAttribute(L)) : h && qq(h).remove(), G = G && h, B = qq(d).getByClass(Q.editFilenameInput).length > 0, C = qq(d).getByClass(Q.retry).length > 0, c = qq(d).getByClass(Q.list)[0], null == c)throw new Error("Could not find the file list container in the template!");
    ...
    function d(b, c) {
        var d = a.paramsStore.get(b), h = a.demoMode ? "GET" : "POST", i = a.endpointStore.get(b), j = f(b);
    ...
    function e(c, e, g, h) {
        ...
        if (m.save(), !qq.supportedFeatures.unlimitedScaledImageSize) {
            var n = d({origWidth: k, origHeight: l});
    ...
    qq.extend(this, {
        enabled: qq.supportedFeatures.scaling && i.length > 0, getFileRecords: function (a, j, k) {
            ...
            return o.isPreviewableSync() ? (qq.each(i, function (a, c) {
                ...
                m.push({
                    uuid: qq.getUniqueId(),
                    name: l._getName(j, {name: c.name, type: i, refType: n.type}),
            ...
            }), c && m.push({uuid: a, name: j, blob: n})) : m.push({uuid: a, name: j, blob: n}), m
            ...
            qq.each(i.getFileRecords(c, b, a), function (b, c) {
                ...
                c.blob instanceof qq.BlobProxy && (h = c.blob, i = -1), g = m.addFile({
                    ...
                    batchId: f,
                    proxyGroupId: o
                }), c.blob instanceof qq.BlobProxy ? j.push(g) : k = g, l(g, h), e.push({id: g, file: h})
