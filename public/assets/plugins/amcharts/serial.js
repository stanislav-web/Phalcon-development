...
AmCharts.Cuboid = AmCharts.Class({
    construct: function (a, b, c, d, e, f, l, h, g, k, m, p, v, r, s, n) {
        ...
        var b = this.container, c = this.w, d =
            this.h, e = this.dx, f = this.dy, l = this.colors, h = this.alpha, g = this.bwidth, k = this.bcolor, m = this.balpha, p = this.gradientRotation, v = this.cornerRadius, r = this.dashLength, s = this.pattern, n = this.topRadius, w = l, q = l;
...
AmCharts.CategoryAxis = AmCharts.Class({
    inherits: AmCharts.AxisBase, construct: function (a) {
        ...
        if (AmCharts.ifArray(a)) {
            ...
            b = this.end - d + 1;
            var l = this.gridCountR, h = this.showFirstLabel, g = this.showLastLabel, k, m = "", p = AmCharts.extractPeriod(this.minPeriod);
            ...
            if (this.parseDates && !this.equalSpacing) {
                ...
                var l = Math.ceil(this.timeDifference / r) + 5, D = m = AmCharts.resetDateToMin(new Date(this.startTime - r), e,
                    v, x).getTime();
