...
   .success(function(response){callback(response);});};service.UserApply=function(data){$rootScope.user=data.user;};service.Logout=function(){$rootScope.user={};};return service;}]);})(angular);;"use strict";phl.controller('TopMenuController',['$scope','$location','$translatePartialLoader','$splash','$http','$sce','$rootScope','$anchorScroll',function($scope,$location,$translatePartialLoader,$splash,$http,$sce,$rootScope,$anchorScroll){$translatePartialLoader.addPart('menu');$scope.isActive=function(route){if($location.hash()!=''){$anchorScroll();return route===$location.url()+'#'+$location.hash();}
