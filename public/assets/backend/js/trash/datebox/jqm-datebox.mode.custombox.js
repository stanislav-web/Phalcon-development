...
(function ($) {
    $.extend($.mobile.datebox.prototype.options, {
        ...
        customData: [
            ...
            {'input': true, 'name': 'Text', 'data': ['some', 'bull', 'shtuff', 'here']},
            {
                'input': false,
                'name': 'Image',
                'data': ['<img src="img/slot1.png" />', '<img src="img/slot2.png" />', '<img src="img/slot3.png" />', '<img src="img/slot4.png" />']
            }
        ],
        customDefault: [0, 0, 0],
        customFormat: false,
    ...
    $.extend($.mobile.datebox.prototype, {
        _cbox_offset: function (fld, amount) {
            ...
            if (tmp < 0) {
                tmp = o.customData[fld]['data'].length + tmp;
            }
    ...
    $.extend($.mobile.datebox.prototype._build, {
        'custombox': function () {
            var w = this,
                ...
                inDiv = $("<div>").addClass('ui-input-text ui-corner-all ui-shadow-inset ui-body-' + o.themeInput).css({
                    'padding': '.4em',
                    'margin': '.5em 0',
                    'text-align': 'center'
                }),
            ...
            for (i = 0; i < o.customData.length; i++) {
                ...
                }).addClass('ui-block-' + tmp).buttonMarkup(butPTheme).appendTo(divPlus);
                w._makeEl(butBase, {
                    'attr': {
                        'field': i,
                        'amount': 1
                    }
                }).addClass('ui-block-' + tmp).buttonMarkup(butMTheme).appendTo(divMinus);
                cnt++;
            }
