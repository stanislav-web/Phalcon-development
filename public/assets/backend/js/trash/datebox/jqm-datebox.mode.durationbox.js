...
(function ($) {
        ...
        _durbox_enter: function (item) {
            ...
            w.d.intHTML.find('input').each(function () {
                switch ($(this).parent().jqmData('field')) {
                    case 'd':
                        t += (60 * 60 * 24) * w._durbox_valid($(this).val());
                        break;
                    case 'h':
                        t += (60 * 60) * w._durbox_valid($(this).val());
                        break;
                    case 'i':
                        t += (60) * w._durbox_valid($(this).val());
                        break;
                    case 's':
                        t += w._durbox_valid($(this).val());
                        break;
                }
            });
    ...
    $.extend($.mobile.datebox.prototype._build, {
        'durationbox': function () {
            ...
            // DAYS
            cDur[0] = parseInt(i / ival.d, 10);
            i = i % ival.d;
            // HOURS
            cDur[1] = parseInt(i / ival.h, 10);
            i = i % ival.h;
            // MINS AND SECS
